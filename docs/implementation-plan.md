...
| 2026-08-30 | 5–7 | Pointed the project-scoped Codex MCP configuration at the production OpenAI-hosted tunnel using ChatGPT-session authentication; retained an explicit command-line override for local-server testing. | Official Secure MCP Tunnel and Codex MCP configuration documentation |
