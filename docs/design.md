...
| 2026-09-10 | Adopt `energy-credit/v3`: surplus above maintenance, bounded extra restriction with variable duration, and protected recovery first. | Schema v4 adds audited trip/context and explicit day reviews; calorie-based prompts ask for context and return dates without creating personal records. Debit accounting starts 2026-09-09. |
