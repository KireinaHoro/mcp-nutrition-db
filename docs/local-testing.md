...
6. Log a training session with measurement method, confidence, and evidence;
   verify reported and credited burn remain distinct and the exercise allowance
   is presented as an optional ceiling.
